                ...
                <tr>
                    <td>
                        <div style="background-color: #CCE4FF; padding-top: 2rem;">
                            <div>
                                <h1 style="color: #2F2E7C; text-align: center; font-weight: 800; margin: 0;">Token Purchase</h1>
                            </div>
                            <div
                                ...
                                <tr>
                                    <td>
                                        <div style="padding: 3.5rem 2.5rem; color: #495057;">
                                            <p>Here is your token for ${assetName}: <b>${token}</b></p>
                                            <p>Visit the Haval Mobile App and purchase ${assetName} via token purchase <p>
